        ...
        <div>
            <form method="POST" action="/users/edit/{{$user->id}}" enctype="multipart/form-data">
                ...
                <div class="form-group offset-md-2 offset-ld-2 offset-0 col-md-8 col-lg-8 col-12">
                    ...
                    <input class="form-control" type="text" id="fullname" name="fullname" value="{{$user->name}}">
                </div>
                <div class="form-group offset-md-2 offset-ld-2 offset-0 col-md-8 col-lg-8 col-12">
                ...
                <div class="form-group offset-md-2 offset-ld-2 offset-0 col-md-8 col-lg-8 col-12">
                    ...
                    <select id="docType" class="form-control" name="company_id">
                        @foreach($companyList as $value)
                            <option value="{{$value['id']}}" @if($value['id'] === $user->company_id) selected @endif>>{{$value['name']}}</option>
                        @endforeach
                    </select>
                </div>
